      ...
      justify-center gap-4">
          {
            fields && (
              ...
              text-center text-lg font-semibold ${alertStatus === 'danger' ? 'bg-red-400 text-red-800' :
                    ...
                    <label className="w-full h-full flex flex-col items-center
                     justify-center cursor-pointer">
                      ...
                      justify-center gap-2">
                        ...
                        <p className="text-gray-500 hover:text-gray-700"> Click to Upload</p>
                      </div>
          ...
          <div className="w-full flex flex-col md:flex-row items-center
           gap-3">
            <div className="w-full py-2 border-b bord-gray-300 flex
             items-center gap-2">
              <MdFoodBank className="text-gray-700 text-2xl"/>
              <input type="text" required value={ calories } 
              onChange={(e) => setCalories(e.target.value)} placeholder="calories" className="w-full
            ...
            <div className="w-full py-2 border-b bord-gray-300 flex
             items-center gap-2">
              ...
              onChange={(e) => setPrice(e.target.value)} placeholder="Price" className="w-full
               h-full text-lg bg-transparent outline-none border-none
                placeholder:text-gray-400 text-textColor" />
             </div>
           </div>
